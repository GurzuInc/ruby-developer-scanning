Gem::Specification.new do |s|
  ...
  s.files       = ["main", "data/questions.yaml", "lib/answer_formator.rb", "lib/interview.rb", "lib/interview_cli.rb", "lib/question.rb", "lib/question_set.rb","lib/user.rb", "lib/utils.rb"]
  s.homepage    =
